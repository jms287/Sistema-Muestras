...
router.post('/norma/get', requireRoles([ROLE.ADMIN, ROLE.REGISTRADOR, ROLE.ANALISTA, ROLE.EVALUADOR]), async (req, res) => {
  try {
...
router.post('/norma/set', requireRoles([ROLE.ADMIN]), async (req, res) => {
  try {

...
router.post('/tipomuestra/get', requireRoles([ROLE.ADMIN, ROLE.REGISTRADOR, ROLE.ANALISTA, ROLE.EVALUADOR, ROLE.SOLICITANTE]), async (req, res) => {
  try {
...
router.post('/tipomuestra/set', requireRoles([ROLE.ADMIN]), async (req, res) => {
  try {
